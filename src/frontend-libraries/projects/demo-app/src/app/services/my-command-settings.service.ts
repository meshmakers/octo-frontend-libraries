  ...
  constructor() {
    ...
    this._commandItems = [
      ...
      },
      {
        ...
        svgIcon: tenancy,
        isVisible: async () =>
          (await this.isSystemTenant()) && (await this.isSystemTenant()),
      ...
      },
      {
        ...
        svgIcon: settings,
        link: async () =>
          `/${await this.getCurrentTenantId()}/process-designer`,
      },
      {
        id: 'symbol-library',
        type: 'link',
      ...
      },
      {
        ...
        children: [
          ...
          { id: 'sep1', type: 'separator' },
          {
            ...
            svgIcon: graphic_eq,
            href: async () =>
              `${this.getAssetServicesUri()}tenants/${await this.getCurrentTenantId()}/graphql/playground`,
            target: '_blank',
            text: 'GraphQL Editor',
          },
        ],
