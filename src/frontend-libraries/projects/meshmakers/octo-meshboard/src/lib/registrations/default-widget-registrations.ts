  ...
  registry.registerWidget<KpiWidgetConfig, KpiConfigResult>({
    ...
    getInitialConfig: (widget) => {
      ...
      return {
        ...
        initialEntitySelectorId: isPersistentQuery ? (kpiWidget.dataSource as PersistentQueryDataSource).entitySelectorId : undefined,
  ...
  registry.registerWidget<GaugeWidgetConfig, GaugeConfigResult>({
    ...
    getInitialConfig: (widget) => {
      ...
      return {
        ...
        initialEntitySelectorId: isPersistentQuery ? (gaugeWidget.dataSource as PersistentQueryDataSource).entitySelectorId : undefined,
  ...
  registry.registerWidget<HeatmapWidgetConfig, HeatmapConfigResult>({
    ...
    fromPersistedConfig: (data: PersistedWidgetData, base: BaseWidgetConfig): HeatmapWidgetConfig => {
      ...
      return {
        ...
        colorMode: config['colorMode'] as HeatmapWidgetConfig['colorMode'] | undefined,
        thresholdTarget: config['thresholdTarget'] as number | undefined,
        showLegend: (config['showLegend'] as boolean) ?? true,
