        ...
        <div class="sort-options-section">
          ...
          <div class="sort-buttons">
            <button
              ...
              [themeColor]="
                currentSortOrder === 'standard' ? 'primary' : 'base'
              "
            ...
            <button
              ...
              [svgIcon]="sortAscIcon"
              [fillMode]="
                currentSortOrder === 'ascending' ? 'solid' : 'outline'
              "
              [themeColor]="
                currentSortOrder === 'ascending' ? 'primary' : 'base'
              "
            ...
            <button
              ...
              [fillMode]="
                currentSortOrder === 'descending' ? 'solid' : 'outline'
              "
              [themeColor]="
                currentSortOrder === 'descending' ? 'primary' : 'base'
              "
              ...
              <ng-template kendoGridCellTemplate let-dataItem>
                <div class="sort-display">
                  <span class="sort-indicator">{{
                    getSortIndicator(dataItem.sortOrder)
                  }}</span>
  ...
  ngOnInit(): void {
    ...
    if (this.data) {
      ...
      if (
        ...
        this.data.selectedAttributes.length > 0
      ) {
